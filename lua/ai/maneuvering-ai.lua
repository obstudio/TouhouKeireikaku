...
function SmartAI:shouldUseAnaleptic(target, slash)
	...
	--Ĭ��ɱ��effective �Ѿ�check���ˣ�


	--���˹�ֵ  �������� �������
	--��ȱ�ж��Ƿ���Ҫ����ʹ��damageEffect ������
	...
	if target:hasSkill("shengchun") then
		return false
	end
	
	--����������󣺷��߱��Բߡ�
	if self:isHugeDamageResisted(target) then
		return false
	end
...
function SmartAI:searchForAnaleptic(use, enemy, slash)
	...
	--ʹ�þƲ���getTurnUseCard������ ���ǹ�getCardId getCardId�޷�����0��ת���� ֻ����ʱ���
...
function SmartAI:useCardFireAttack(fire_attack, use) --���� �Ծ�+��+��ɱ Ȼ���ɱ������
	local lack = {
		spade = true,
		club = true,
		heart = true,
