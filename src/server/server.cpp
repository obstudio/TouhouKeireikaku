...
QWidget *ServerDialog::createAdvancedTab()
{
	...
	samode_checkbox = new QCheckBox(tr("SA Mode"));
	samode_checkbox->setChecked(Config.SAMode);
	...
	layout->addWidget(samode_checkbox);
...
bool ServerDialog::config()
{
	...
	Config.SAMode = samode_checkbox->isChecked(); // for samode
	...
	Config.setValue("SAMode", Config.SAMode);
