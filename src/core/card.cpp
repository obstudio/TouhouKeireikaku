...
/*const QString Card::className() const
{
	const QString cardp = objectName();
	if (isKindOf("Slash"))
		return "Slash";
	else if (isKindOf("Jink"))
		return "Jink";
	else if (isKindOf("Peach"))
		return "Peach";
	else if (isKindOf("Analeptic"))
		return "Analeptic";
	else if (cardp == "duel")
		return "Duel";
	else if (cardp == "god_salvation")
		return "GodSalvation";
	else if (cardp == "fire_attack")
		return "FireAttack";
	else if (cardp == "amazing_grace")
		return "AmazingGrace";
	else if (cardp == "savage_assault")
		return "SavageAssault";
	else if (cardp == "iron_chain")
		return "IronChain";
	else if (cardp == "archery_attack")
		return "ArcheryAttack";
	else if (cardp == "collateral")
		return "Collateral";
	else if (cardp == "dismantlement")
		return "Dismantlement";
	else if (cardp == "ex_nihilo")
		return "ExNihilo";
	else if (cardp == "snatch")
		return "Snatch";
	else
		return ""
}*/
...
QString DummyCard::getSkillName(bool removePrefix) const
{
    if (m_skillName.startsWith("_") && removePrefix)
        return m_skillName.mid(1);
    else
...
void DummyCard::setSkillName(const QString &name)
{
    m_skillName = name;
}
