...
local t = {
	...
	["collateral-slash"] = "%dest 使用了【纵驭刃息】，请对 %src 使用一张【杀】",
	...
	[":wooden_ox"] = "装备牌·宝物<br /><b>宝物技能</b>：<br />" ..
					"1. 阶段技。你可以将一张手牌置于【阴阳玉】下：若如此做，你可以将【阴阳玉】移动至一名其他角色的装备区。<br />" ..
					"2. 你可以将【阴阳玉】下的牌视为手牌使用或打出。<br />" ..
					"◆每当你失去装备区的【阴阳玉】后，若【阴阳玉】未移动至装备区，其下的牌置入弃牌堆，否则这些牌仍置于【阴阳玉】下。<br />◆【阴阳玉】下的牌为移出游戏。",
	["@wooden_ox-move"] = "你可以将【阴阳玉】移动至一名其他角色的装备区",
